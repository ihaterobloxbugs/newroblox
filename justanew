...
local Window = Rayfield:CreateWindow({
 ...
 local Tab = Window:CreateTab("Ults", 4483362458) -- Title, Image
 ...
 local Button = Tab:CreateButton({
    Name = "Freeze",
    Callback = function()
        game:GetService("ReplicatedStorage"):WaitForChild("CompassNeedle"):WaitForChild("RemoteEvent"):FireServer()
    end,
 })
